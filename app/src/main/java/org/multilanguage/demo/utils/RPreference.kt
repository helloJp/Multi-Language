 ...
 * @author jiangp
 * @date   2019-07-31.
 * @desc: https://github.com/WindSekirun/RichUtilsKt/blob/master/RichUtils/src/main/java/pyxis/uzuki/live/richutilskt/utils/RPreference.kt
 */
class RPreference private constructor(context: Context) {
     ...
     */
    @JvmOverloads
    fun getString(key: String, def: String = ""): String = getValue({ pref.getString(key, def) }, def)
     ...
     */
    @JvmOverloads
    fun getChar(key: String, def: Char = '\u0000'): Char = getValue({ pref.getString(key, def.toString())[0] }, def)
     ...
     */
    @JvmOverloads
    fun getCharSequence(key: String, def: CharSequence = ""): CharSequence = getValue({ pref.getString(key, def.toString()) }, def)
     ...
     */
    @JvmOverloads
    fun getInt(key: String, def: Int = 0): Int = getValue({ pref.getInt(key, def) }, def)
     ...
     */
    @JvmOverloads
    fun getDouble(key: String, def: Double = 0.toDouble()): Double = getValue({ pref.getString(key, def.toString()).toDouble() }, def)
     ...
     */
    @JvmOverloads
    fun getBoolean(key: String, def: Boolean = false): Boolean = getValue({ pref.getBoolean(key, def) }, def)
